        ...
        >
          ...
          >
            ...
            <div className="mb-6">
              ...
              <h2
                className={`text-2xl font-bold bg-clip-text text-${Colors.primaryMain}`}
              >
            ...
            <div className="flex gap-3 mb-6">
              <select className="border border-gray-200 rounded-lg px-3 py-2 text-sm bg-gray-50 text-gray-800 focus:ring-2 focus:ring-purple-500">
        ...
        >
          ...
          >
            ...
            <div className="flex mb-6">
              <select className="border border-gray-200 rounded-l-lg px-3 py-2 text-sm bg-gray-50 text-gray-800  focus:ring-purple-500">
                <option value="+91">+91</option>
                <option value="+1">+1</option>
                <option value="+44">+44</option>
              </select>
              <input
                ...
                placeholder="Enter your phone number"
                className={`flex-1 border border-gray-200 rounded-r-lg px-4 py-2 text-sm bg-gray-50 focus:ring-2 focus:ring-${Colors.primaryMain}`}
              />
            </div>
