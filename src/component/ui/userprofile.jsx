        ...
        <div className="p-6 text-center">
          <div className="relative inline-block">
            <img
              ...
              alt="Profile"
              className={`w-20 h-20 rounded-full object-cover border-4 border-[#542374] shadow-md`}
            />
            <button
              onClick={() => setShowUploadModal(true)}
              className={`absolute bottom-0 right-0 p-2 bg-gradient-to-r ${Colors.gradientFrom} ${Colors.gradientTo} text-white rounded-full shadow-lg hover:bg-orange-600`}
            >
              <FaCamera size={14} />
            </button>
          </div>
