...
const WhyUs = () => {
  ...
  const sharedStyles = {
    ...
    card: "bg-purple-100 shadow-lg rounded-xl border border-gray-100 flex flex-col items-center text-center p-6 hover:shadow-xl transition-shadow duration-300",
    icon: "text-5xl mb-4",
