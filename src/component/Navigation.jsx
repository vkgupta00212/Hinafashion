          ...
          <div className="flex justify-between items-center h-[80px]">
            ...
            >
              <img
                src={logo}
                alt="WePrettify Logo"
                className="w-[140px] h-[80px] rounded-full object-cover group-hover:scale-105 transition-transform duration-300"
              />
            </div>
            ...
            <div className="hidden md:flex items-center space-x-10 text-lg font-medium">
              ...
              {isLoggedIn ? (
                ...
                <button
                  ...
                  className={`px-4 py-2 bg-[#b73b84] text-white rounded-lg hover:cursor-pointer hover:bg-[#542374] transition-all duration-300 ${
